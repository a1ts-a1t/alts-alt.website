...
This is not meant to be a fully featured pixel art engine by any stretch of the imagination, but it provides just enough functionality for me to at least make my icons way faster than I did before. If it happens to be something that is useful to you, that’s fantastic! If it ends up being so useful to you that you get annoyed at how few features there are, I encourage you to create a feature request on [this website’s GitHub page](https://github.com/a1ts-a1t/alts-alt.neocities.org/issues).
